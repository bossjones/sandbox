...
from upscale_cli import constants
from upscale_cli.dbx_logger import get_logger  # noqa: E402
from upscale_cli.utils.config import Config
...
# log = logging.getLogger("upscale_cli.utils")

LOGGER = get_logger("upscale_cli.utils", provider="Utils", level=logging.DEBUG)
