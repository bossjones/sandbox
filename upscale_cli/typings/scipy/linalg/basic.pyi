...
def solve_banded(l_and_u, ab, b, overwrite_ab=..., overwrite_b=..., debug=..., check_finite=...):
    """
...
def solve_circulant(c, b, singular=..., tol=..., caxis=..., baxis=..., outaxis=...):
...
def lstsq(a, b, cond=..., overwrite_a=..., overwrite_b=..., check_finite=..., lapack_driver=...): # -> tuple[Unknown, Unknown, Literal[0], Unknown] | tuple[Unknown | Unbound, Unknown, Unknown | Unbound, Unknown | Unbound] | tuple[Unknown, Unknown, Unknown, None] | None:
    """
...
def pinv2(a, cond=..., rcond=..., return_rank=..., check_finite=...): # -> tuple[Unknown, Unknown]:
    """
    Compute the (Moore-Penrose) pseudo-inverse of a matrix.
...
def pinvh(a, atol=..., rtol=..., lower=..., return_rank=..., check_finite=..., cond=..., rcond=...): # -> tuple[Unknown, int]:
    """
...
def matrix_balance(A, permute=..., scale=..., separate=..., overwrite_a=...): # -> tuple[Unknown, tuple[Unknown, Unknown]] | tuple[Unknown, Unknown]:
    """
