...
def polydiv(c1, c2): # -> tuple[Unknown, Unknown]:
    """
...
def polyvander3d(x, y, z, deg): # -> Any:
    """Pseudo-Vandermonde matrix of given degrees.
...
def polyfit(x, y, deg, rcond=..., full=..., w=...): # -> tuple[Unknown, list[Unknown]]:
    """
