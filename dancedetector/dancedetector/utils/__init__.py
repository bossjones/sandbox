...
from dancedetector import constants
from dancedetector.dbx_logger import get_logger  # noqa: E402
from dancedetector.utils.config import Config
...
# log = logging.getLogger("dancedetector.utils")

LOGGER = get_logger("dancedetector.utils", provider="Utils", level=logging.DEBUG)
