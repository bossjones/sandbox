...
_iermess2 = ...
_parcur_cache = ...
def splprep(x, w=..., u=..., ub=..., ue=..., k=..., task=..., s=..., t=..., full_output=..., nest=..., per=..., quiet=...): # -> tuple[tuple[list[Any | list[Any] | Unknown], Any], Any, Any, str | Type[ValueError] | Type[TypeError] | None] | tuple[list[Any | list[Any] | Unknown], Any]:
    """
...
_curfit_cache = ...
def splrep(x, y, w=..., xb=..., xe=..., k=..., task=..., s=..., t=..., full_output=..., per=..., quiet=...): # -> tuple[tuple[Unknown, Any, Unknown], Any, Any, str | Type[ValueError] | Type[TypeError] | None] | tuple[Unknown, Any, Unknown]:
    """
...
_surfit_cache = ...
def bisplrep(x, y, z, w=..., xb=..., xe=..., yb=..., ye=..., kx=..., ky=..., task=..., s=..., eps=..., tx=..., ty=..., full_output=..., nxest=..., nyest=..., quiet=...): # -> tuple[list[Any | Unknown], Any, Any, str | Type[ValueError] | Type[TypeError] | None] | list[Any | Unknown]:
    """
...
def splder(tck, n=...): # -> tuple[Unknown, Unknown, Unknown]:
    """
...
def splantider(tck, n=...): # -> tuple[Unknown, Unknown, Unknown]:
    """
