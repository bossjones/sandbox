...
class Rectangle:
    ...
    def min_distance_point(self, x, p=...):
        """
    ...
    def max_distance_point(self, x, p=...):
        """
    ...
    def min_distance_rectangle(self, other, p=...):
        """
    ...
    def max_distance_rectangle(self, other, p=...):
        """
...
class KDTree(cKDTree):
    ...
    def query(self, x, k=..., eps=..., p=..., distance_upper_bound=..., workers=...): # -> tuple[list[Unknown], list[Unknown]] | tuple[Unknown, Unknown]:
...
def distance_matrix(x, y, p=..., threshold=...):
