...
"""
def lobpcg(A, X, B=..., M=..., Y=..., tol=..., maxiter=..., largest=..., verbosityLevel=..., retLambdaHistory=..., retResidualNormsHistory=...): # -> tuple[Unknown, Unknown] | tuple[Unknown, Unknown, list[Unknown], list[Unknown]] | tuple[Unknown, Unknown, list[Unknown]]:
    """Locally Optimal Block Preconditioned Conjugate Gradient Method (LOBPCG)
