...
from html_to_markdown_cli import constants
from html_to_markdown_cli.dbx_logger import get_logger  # noqa: E402
from html_to_markdown_cli.utils.config import Config
...
# log = logging.getLogger("html_to_markdown_cli.utils")

LOGGER = get_logger("html_to_markdown_cli.utils", provider="Utils", level=logging.DEBUG)
