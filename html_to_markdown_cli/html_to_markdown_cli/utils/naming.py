...
def magic_name(value, *, path_prefix):
    ...
    try:
        ...
        # https://github.com/html_to_markdown_cli/html_to_markdown_cli/pull/1635
        if inspect.isframe(frame):
            frame = frame.f_back

        # Iterate frames while filename starts with path_prefix (part of html_to_markdown_cli)
