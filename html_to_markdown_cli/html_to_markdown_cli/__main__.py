...
from html_to_markdown_cli.dbx_logger import get_logger, intercept_all_loggers  # noqa: E402

LOGGER = get_logger(__name__, provider="html_to_markdown_cli", level=logging.DEBUG)
