...
from tweetpik_cli.utils.config import Config
...
# log = logging.getLogger("tweetpik_cli.utils")

LOGGER = get_logger("tweetpik_cli.utils", provider="Utils", level=logging.DEBUG)
