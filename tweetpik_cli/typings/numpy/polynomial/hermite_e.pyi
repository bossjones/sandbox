...
def hermediv(c1, c2): # -> tuple[Unknown, Unknown]:
    """
...
def hermevander3d(x, y, z, deg): # -> Any:
    """Pseudo-Vandermonde matrix of given degrees.
...
def hermefit(x, y, deg, rcond=..., full=..., w=...): # -> tuple[Unknown, list[Unknown]]:
    """
...
def hermegauss(deg): # -> tuple[Unknown, Unknown]:
    """
