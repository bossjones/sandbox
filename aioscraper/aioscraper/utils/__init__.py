...
from aioscraper import constants
from aioscraper.dbx_logger import get_logger  # noqa: E402
from aioscraper.utils.config import Config
...
# log = logging.getLogger("aioscraper.utils")

LOGGER = get_logger("aioscraper.utils", provider="Utils", level=logging.DEBUG)
